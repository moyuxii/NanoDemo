...
import (
	...
	"NanoDemo/main/db"
	"NanoDemo/main/internal/web/api"
	"NanoDemo/main/pkg/algoutil"
	"NanoDemo/main/pkg/whitelist"
	"NanoDemo/main/protocol"
...
func dbStartup() func() {
	dsn := fmt.Sprintf("%s", viper.GetString("database.dbname"))
	fmt.Println("数据库名称为", dsn)
...
func enableWhiteList() {
	_ = whitelist.Setup(viper.GetStringSlice("whitelist.ip"))
}
